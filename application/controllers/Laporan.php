...
public function print_anggota_pdf()
{
	{
		$this->load->library('dompdf_gen');
		...
		$this->load->view('user/print_anggota_pdf', $data);
...
public function print_pelanggan_pdf()
{
	{
		$this->load->library('dompdf_gen');
		...
		$this->load->view('user/print_pelanggan_pdf', $data);
...
public function export_excel_anggota()
{
	...
	$this->load->view('user/print_anggota_excel', $data);
}
...
public function export_excel_pelanggan()
{
	...
	'pelanggan' => $this->db->get('user')->result_array()
	);

	$this->load->view('user/print_pelanggan_excel', $data);
}
